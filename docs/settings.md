...
<p align="center">
  <img src="screenshots/settings-window.png" width="492"
       alt="설정 창. 사내 Wi-Fi 이름(EXEM)과 IP 주소·서브넷 마스크·라우터·DNS 서버가 채워져 있고, 권한 네 항목(전환·설정 저장·위치·알림)이 모두 갖춰진 상태. 그 아래 '로그인 시 자동 실행' 체크상자, 맨 아래 줄 왼쪽에 빨간 글자 '앱 삭제…' 와 오른쪽에 '취소'·'저장'." />
</p>

<sub>[README 의 설치](../README.md#설치) 3단계와 4단계를 하는 화면입니다. 위쪽 다섯 칸에 사내 값을
