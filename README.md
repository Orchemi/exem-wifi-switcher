...
<details>
<summary><b>앱이 열리지 않아 [제거] 버튼을 누를 수 없다면</b> (터미널)</summary>
...
터미널로 제거할 때는 **로그인 항목이 빠집니다.** 그것만은 파일이 아니라 macOS 가 관리하는 기록이라 셸에서 끌 방법이
없습니다. 대신 스크립트가 끄는 방법을 안내합니다. 앱의 **[제거]** 를 쓰면 앱이 함께 끕니다.
